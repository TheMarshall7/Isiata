  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-start">
      <div className="relative lg:sticky lg:top-28 flex items-center justify-center aspect-[4/3] p-12 md:p-16 isolate">
        ...
        <AreoClientWhiteLogo alt={tierName} className="relative w-full max-w-[220px] h-auto" />
      </div>
      ...
      <Stagger className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {benefits.map((benefit) => (
          <div
            key={benefit.title}
            className="flashlight-card hover-glow gradient-border border border-white/10 bg-surface-raised/30 p-5 lg:p-6"
          >
