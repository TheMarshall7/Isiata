          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {CATEGORIES.map((cat) => (
              <a
                key={cat.href}
                href={cat.href}
                className="group flashlight-card hover-lift hover-glow relative aspect-[4/3] overflow-hidden bg-zinc-900/80 border border-white/10 p-12 flex flex-col justify-end"
                onMouseMove={(e) => {
